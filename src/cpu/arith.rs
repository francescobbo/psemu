...
impl Cpu {
    ...
    pub(super) fn ins_addi(&mut self, instr: Instruction) {
        ...
        let result = self.get_rs(instr) + immediate;
...
mod tests {
    ...
    fn test_add() {
        ...
        cpu.registers[7] = 1;
        cpu.registers[8] = 2;
        cpu.execute(Instruction(0x00107_4020)); // ADD r8, r7, r8
    ...
    fn test_add_overflow() {
        let mut cpu = Cpu::new();
        cpu.registers[7] = 0xffff_0000;
        cpu.registers[8] = 0x0002_ffff;
        cpu.execute(Instruction(0x00107_4020)); // ADD r8, r7, r8
    }
    ...
    fn test_sub() {
        ...
        cpu.registers[7] = 1;
        cpu.registers[8] = 2;
        cpu.execute(Instruction(0x00107_4022)); // SUB r8, r7, r8
