...
impl Ram {
    /// Creates a new RAM instance with the default size of 2 MiB.
    /// The RAM is initialized with zeroes.
    pub fn new() -> Self {
        Ram {
            data: vec![0; RAM_SIZE],
        }
    ...
    /// Performs a read operation from the RAM, of size 1, 2, or 4 bytes.
    ...
    /// Performs a write operation to the RAM, of size 1, 2, or 4 bytes.
